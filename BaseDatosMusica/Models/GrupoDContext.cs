...
public partial class GrupoDContext : DbContext
{
    ...
    public GrupoDContext(IConfiguration configuration)
    {
    ...
    public GrupoDContext(DbContextOptions<GrupoDContext> options, IEnumerable? role)
        : base(options)
    {
        Role = role;
    }
...
//    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    ...
    public DbSet<BaseDatosMusica.Models.VistaCancione> VistaCancione { get; set; } = default!;
}
